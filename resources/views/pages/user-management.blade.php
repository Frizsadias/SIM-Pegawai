                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle text-right text-sm ps-2">
                                                    <span
                                                        class="badge badge-sm bg-gradient-success">{{ auth()->user()->role }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <a class="btn btn-secondary btn-sm dropdown-toggle bg-gradient-info" href="#"
