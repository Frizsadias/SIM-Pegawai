        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="text-right card-header pb-0">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">First Name</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">Last name</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">Role</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="badge badge-sm bg-gradient-secondary">{{ auth()->user()->role }}</td>
                                </tr>
                            </tbody>
                        </table>
                                </div>
